                ...
                <div className="grid gap-8 px-10 py-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-gradient-to-r from-blue-400 to-blue-600 p-4 rounded-lg shadow-lg">
                            ...
                            <p className="text-green-200">{calculatePercentageIncrease(lastMonthPatients, thisMonthPatients)}</p>
                        </div>
                        <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 p-4 rounded-lg shadow-lg">
                            ...
                            <p className="text-red-200">{calculatePercentageIncreaseAppointments(lastMonthPatients, thisMonthPatientsAppointment)}</p>
                        </div>
